...
class Application extends Controller {
  ...
  val q11 = """\w+: what is the (\d+)(?:st|th|nd) and (\d+)(?:st|th|nd) number in the Fibonacci sequence""".r
  ...
  def getResponse(q: String): String = {
    q match {
      ...
      case q11(num1, num2) => Seq(fibSeq(num1.toInt).last.toString, fibSeq(num2.toInt).last.toString).mkString(", ")
...
//  val q = "f8fed360: who is the Prime Minister of Great Britan"
  val q = "f8fed360: what is the 1st and 2nd number in the Fibonacci sequence"
